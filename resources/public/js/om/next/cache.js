...
var self__ = this;
var this$ = this;
var x_SINGLEQUOTE__41019 = cljs.core.vary_meta.call(null,x,cljs.core.assoc,new cljs.core.Keyword(null,"client-time","client-time",-1212214195),(new Date()));
if((self__.size <= self__.arr.length)){
var id_SINGLEQUOTE__41020 = self__.arr.shift();
cljs.core.swap_BANG_.call(null,self__.index,((function (id_SINGLEQUOTE__41020,x_SINGLEQUOTE__41019,this$){
return (function (p1__41018_SHARP_){
return cljs.core.assoc.call(null,cljs.core.dissoc.call(null,p1__41018_SHARP_,id_SINGLEQUOTE__41020),id,x_SINGLEQUOTE__41019);
});})(id_SINGLEQUOTE__41020,x_SINGLEQUOTE__41019,this$))
);
} else {
cljs.core.swap_BANG_.call(null,self__.index,cljs.core.assoc,id,x_SINGLEQUOTE__41019);
}
...
om.next.cache.Cache.cljs$lang$ctorPrWriter = (function (this__21332__auto__,writer__21333__auto__,opt__21334__auto__){
return cljs.core._write.call(null,writer__21333__auto__,"om.next.cache/Cache");
});
