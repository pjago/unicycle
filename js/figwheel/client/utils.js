...
var or__27322__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj50724 = {"detail":data};
return obj50724;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__27310__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__27310__auto__)){
var and__27310__auto____$1 = (window["CustomEvent"]);
...
var args50733 = [];
var len__28543__auto___50739 = arguments.length;
var i__28544__auto___50740 = (0);
while(true){
if((i__28544__auto___50740 < len__28543__auto___50739)){
args50733.push((arguments[i__28544__auto___50740]));

var G__50741 = (i__28544__auto___50740 + (1));
i__28544__auto___50740 = G__50741;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args50733.length)].join('')));
...
var f = (function (){var pred__50736 = cljs.core._EQ_;
var expr__50737 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__50736.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__50737))){
return ((function (pred__50736,expr__50737){
return (function (p1__50729_SHARP_){
return console.warn(p1__50729_SHARP_);
});
;})(pred__50736,expr__50737))
} else {
if(cljs.core.truth_(pred__50736.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__50737))){
return ((function (pred__50736,expr__50737){
return (function (p1__50730_SHARP_){
return console.debug(p1__50730_SHARP_);
});
;})(pred__50736,expr__50737))
} else {
if(cljs.core.truth_(pred__50736.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__50737))){
return ((function (pred__50736,expr__50737){
return (function (p1__50731_SHARP_){
return console.error(p1__50731_SHARP_);
});
;})(pred__50736,expr__50737))
} else {
return ((function (pred__50736,expr__50737){
return (function (p1__50732_SHARP_){
return console.log(p1__50732_SHARP_);
});
;})(pred__50736,expr__50737))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__50746){
var map__50750 = p__50746;
...
var opts = map__50750__$1;
var eval_fn = cljs.core.get.call(null,map__50750__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__50752_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__50757,(0),null);
var v = cljs.core.nth.call(null,vec__50757,(1),null);
...
var args50761 = [];
var len__28543__auto___50764 = arguments.length;
var i__28544__auto___50765 = (0);
while(true){
if((i__28544__auto___50765 < len__28543__auto___50764)){
args50761.push((arguments[i__28544__auto___50765]));

var G__50767 = (i__28544__auto___50765 + (1));
i__28544__auto___50765 = G__50767;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args50761.length)].join('')));
...
if(cljs.core.truth_((function (){var and__27310__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1493584941007